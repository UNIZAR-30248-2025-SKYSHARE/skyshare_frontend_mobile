...
class PasosObservacion extends StatelessWidget {
  ...
  List<String> _getPasos(dynamic guia) {
    ...
    return pasos.where((p) => p != null && p.toString().trim().isNotEmpty).cast<String>().toList();
  }
      ...
      child: Column(
        ...
        children: [
          Row(mainAxisAlignment: MainAxisAlignment.center, children: const [
            ...
            SizedBox(width: 12),
            Text('Pasos para Observar', style: TextStyle(color: Colors.lightBlueAccent, fontWeight: FontWeight.bold, fontSize: 18)),
          ]),
            ...
            children: pasos.asMap().entries.map((entry) {
              ...
              return Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(color: Colors.lightBlueAccent.withOpacity(0.3), width: 2),
                ),
                child: Row(
                  children: [
                    Container(
